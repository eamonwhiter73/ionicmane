...
export class UserviewuserprofilePage {
  ...
  ionViewDidLoad() {
    ...
    this.item.subscribe(snapshot => {
	    ...
	    this.nativeGeocoder.reverseGeocode(snapshot.location.latitude, snapshot.location.longitude)
